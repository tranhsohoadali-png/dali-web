...
.wrap{max-width:1340px;margin:0 auto;padding:8px 5% 50px;display:grid;grid-template-columns:minmax(0,1fr) minmax(0,1.4fr);gap:40px;align-items:start}
/* LEFT preview */
.preview-box{position:sticky;top:84px;max-width:520px}
