...
<div id="adminSidebar" style="width:220px;flex-shrink:0;background:linear-gradient(175deg,#1C5200,#2D7A08,#3A9A12);display:flex;flex-direction:column;min-height:100vh">
  ...
  <nav style="flex:1;padding:12px 8px;overflow-y:auto">
    ...
    <a href="{{ route('admin.cauhinh3d.index') }}" style="display:flex;align-items:center;gap:10px;padding:10px 12px;border-radius:10px;color:{{ request()->routeIs('admin.cauhinh3d*') ? '#fff' : 'rgba(255,255,255,.65)' }};font-size:13px;font-weight:{{ request()->routeIs('admin.cauhinh3d*') ? '700' : '500' }};text-decoration:none;background:{{ request()->routeIs('admin.cauhinh3d*') ? 'rgba(255,255,255,.18)' : 'transparent' }};border:1px solid {{ request()->routeIs('admin.cauhinh3d*') ? 'rgba(255,255,255,.28)' : 'transparent' }};margin-bottom:2px">💰 <span>Cài đặt 3D</span></a>
