...
<div id="adminSidebar" style="width:220px;flex-shrink:0;background:linear-gradient(175deg,#1C5200,#2D7A08,#3A9A12);display:flex;flex-direction:column;min-height:100vh">
  ...
  <nav style="flex:1;padding:12px 8px;overflow-y:auto">
    ...
    <a href="{{ route('admin.thietke.pricing') }}" style="display:flex;align-items:center;gap:10px;padding:10px 12px;border-radius:10px;color:{{ request()->routeIs('admin.thietke*') ? '#fff' : 'rgba(255,255,255,.65)' }};font-size:13px;font-weight:{{ request()->routeIs('admin.thietke*') ? '700' : '500' }};text-decoration:none;background:{{ request()->routeIs('admin.thietke*') ? 'rgba(255,255,255,.18)' : 'transparent' }};border:1px solid {{ request()->routeIs('admin.thietke*') ? 'rgba(255,255,255,.28)' : 'transparent' }};margin-bottom:2px">
      <svg width="17" height="17" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.8" d="M4 6h16M4 10h16M4 14h16M4 18h16M9 6v12M15 6v12"/></svg>
      Bảng giá Thiết kế
    </a>
    <a href="{{ route('admin.thietke.leads') }}" style="display:flex;align-items:center;gap:10px;padding:10px 12px;border-radius:10px;color:{{ request()->routeIs('admin.thietke.leads') ? '#fff' : 'rgba(255,255,255,.65)' }};font-size:13px;font-weight:{{ request()->routeIs('admin.thietke.leads') ? '700' : '500' }};text-decoration:none;background:{{ request()->routeIs('admin.thietke.leads') ? 'rgba(255,255,255,.18)' : 'transparent' }};border:1px solid transparent;margin-bottom:2px">📱 <span>Khách thiết kế (SĐT)</span></a>
    <a href="{{ route('admin.thietke.queue') }}" style="display:flex;align-items:center;gap:10px;padding:10px 12px;border-radius:10px;color:{{ request()->routeIs('admin.thietke.queue') ? '#fff' : 'rgba(255,255,255,.65)' }};font-size:13px;font-weight:{{ request()->routeIs('admin.thietke.queue') ? '700' : '500' }};text-decoration:none;background:{{ request()->routeIs('admin.thietke.queue') ? 'rgba(255,255,255,.18)' : 'transparent' }};border:1px solid transparent;margin-bottom:2px;position:relative">⏳ <span>Đơn chờ thiết kế</span>@php $pendDesign = \App\Models\Order::where('design_status','pending')->count(); @endphp @if($pendDesign > 0)<span style="position:absolute;right:10px;background:#F59E0B;color:#fff;font-size:10px;font-weight:800;padding:1px 7px;border-radius:20px">{{ $pendDesign }}</span>@endif</a>
    <div style="font-size:9px;letter-spacing:2.5px;color:rgba(255,255,255,.25);padding:8px 10px 5px;margin-top:4px;text-transform:uppercase">Xưởng in 3D</div>
    <a href="{{ route('admin.tongquan3d') }}" style="display:flex;align-items:center;gap:10px;padding:10px 12px;border-radius:10px;color:{{ request()->routeIs('admin.tongquan3d') ? '#fff' : 'rgba(255,255,255,.65)' }};font-size:13px;font-weight:{{ request()->routeIs('admin.tongquan3d') ? '700' : '500' }};text-decoration:none;background:{{ request()->routeIs('admin.tongquan3d') ? 'rgba(255,255,255,.18)' : 'transparent' }};border:1px solid {{ request()->routeIs('admin.tongquan3d') ? 'rgba(255,255,255,.28)' : 'transparent' }};margin-bottom:2px">📊 <span>Tổng quan 3D</span></a>
    <a href="{{ route('admin.sp3d.index') }}" style="display:flex;align-items:center;gap:10px;padding:10px 12px;border-radius:10px;color:{{ request()->routeIs('admin.sp3d*') ? '#fff' : 'rgba(255,255,255,.65)' }};font-size:13px;font-weight:{{ request()->routeIs('admin.sp3d*') ? '700' : '500' }};text-decoration:none;background:{{ request()->routeIs('admin.sp3d*') ? 'rgba(255,255,255,.18)' : 'transparent' }};border:1px solid {{ request()->routeIs('admin.sp3d*') ? 'rgba(255,255,255,.28)' : 'transparent' }};margin-bottom:2px">⚛️ <span>Sản phẩm 3D</span></a>
    <a href="{{ route('admin.danhmuc3d.index') }}" style="display:flex;align-items:center;gap:10px;padding:10px 12px;border-radius:10px;color:{{ request()->routeIs('admin.danhmuc3d*') ? '#fff' : 'rgba(255,255,255,.65)' }};font-size:13px;font-weight:{{ request()->routeIs('admin.danhmuc3d*') ? '700' : '500' }};text-decoration:none;background:{{ request()->routeIs('admin.danhmuc3d*') ? 'rgba(255,255,255,.18)' : 'transparent' }};border:1px solid {{ request()->routeIs('admin.danhmuc3d*') ? 'rgba(255,255,255,.28)' : 'transparent' }};margin-bottom:2px">🗂️ <span>Danh mục 3D</span></a>
    <a href="{{ route('admin.don3d.index') }}" style="display:flex;align-items:center;gap:10px;padding:10px 12px;border-radius:10px;color:{{ request()->routeIs('admin.don3d*') ? '#fff' : 'rgba(255,255,255,.65)' }};font-size:13px;font-weight:{{ request()->routeIs('admin.don3d*') ? '700' : '500' }};text-decoration:none;background:{{ request()->routeIs('admin.don3d*') ? 'rgba(255,255,255,.18)' : 'transparent' }};border:1px solid {{ request()->routeIs('admin.don3d*') ? 'rgba(255,255,255,.28)' : 'transparent' }};margin-bottom:2px">📦 <span>Đơn 3D</span></a>
    <a href="{{ route('admin.diho.index') }}" style="display:flex;align-items:center;gap:10px;padding:10px 12px;border-radius:10px;color:{{ request()->routeIs('admin.diho*') ? '#fff' : 'rgba(255,255,255,.65)' }};font-size:13px;font-weight:{{ request()->routeIs('admin.diho*') ? '700' : '500' }};text-decoration:none;background:{{ request()->routeIs('admin.diho*') ? 'rgba(255,255,255,.18)' : 'transparent' }};border:1px solid {{ request()->routeIs('admin.diho*') ? 'rgba(255,255,255,.28)' : 'transparent' }};margin-bottom:2px;position:relative">🚚 <span>Đơn đi hộ</span>@php $dihoMoi = \App\Models\DonDiHo::where('tt','moi')->count(); @endphp @if($dihoMoi > 0)<span style="position:absolute;right:10px;background:#F59E0B;color:#fff;font-size:10px;font-weight:800;padding:1px 7px;border-radius:20px">{{ $dihoMoi }}</span>@endif</a>
    <a href="{{ route('admin.diho.doisoat') }}" style="display:flex;align-items:center;gap:10px;padding:10px 12px;border-radius:10px;color:{{ request()->routeIs('admin.diho.doisoat') ? '#fff' : 'rgba(255,255,255,.65)' }};font-size:13px;font-weight:{{ request()->routeIs('admin.diho.doisoat') ? '700' : '500' }};text-decoration:none;background:{{ request()->routeIs('admin.diho.doisoat') ? 'rgba(255,255,255,.18)' : 'transparent' }};border:1px solid {{ request()->routeIs('admin.diho.doisoat') ? 'rgba(255,255,255,.28)' : 'transparent' }};margin-bottom:2px">🧮 <span>Đối soát đại lý</span></a>
    <a href="{{ route('admin.daily.index') }}" style="display:flex;align-items:center;gap:10px;padding:10px 12px;border-radius:10px;color:{{ request()->routeIs('admin.daily*') ? '#fff' : 'rgba(255,255,255,.65)' }};font-size:13px;font-weight:{{ request()->routeIs('admin.daily*') ? '700' : '500' }};text-decoration:none;background:{{ request()->routeIs('admin.daily*') ? 'rgba(255,255,255,.18)' : 'transparent' }};border:1px solid {{ request()->routeIs('admin.daily*') ? 'rgba(255,255,255,.28)' : 'transparent' }};margin-bottom:2px">🤝 <span>Đại lý</span></a>
    <a href="{{ route('admin.thayten') }}" style="display:flex;align-items:center;gap:10px;padding:10px 12px;border-radius:10px;color:{{ request()->routeIs('admin.thayten') ? '#fff' : 'rgba(255,255,255,.65)' }};font-size:13px;font-weight:{{ request()->routeIs('admin.thayten') ? '700' : '500' }};text-decoration:none;background:{{ request()->routeIs('admin.thayten') ? 'rgba(255,255,255,.18)' : 'transparent' }};border:1px solid {{ request()->routeIs('admin.thayten') ? 'rgba(255,255,255,.28)' : 'transparent' }};margin-bottom:2px">🏷️ <span>Thay tên mẫu</span></a>
