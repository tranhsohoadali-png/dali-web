      ...
      <form method="POST" action="{{ route('admin.settings.update') }}">
        ...
        <div class="card">
          ...
          <div class="fb">
            ...
            <div class="g2">
              <div><label class="flabel">Zalo OA ID <span class="hint">(chat widget)</span></label><input type="text" name="zalo_oa_id" class="dinput" value="{{ $settings['zalo_oa_id'] ?? '' }}" placeholder="123456789"><div class="fnote">Hiện nút chat Zalo trên website</div></div>
              <div></div>
            </div>
          </div>
        </div>
