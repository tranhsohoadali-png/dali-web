    ...
    <div class="card">
      ...
      <table>
        ...
        <tr>
          ...
          <td>@if($o->nhan_vc_path)<a href="{{ route('admin.diho.nhan', $o) }}" target="_blank" rel="noopener" class="btn-dl">👁 Xem nhãn</a>@else<span style="font-size:11px;color:var(--tx3)">—</span>@endif</td>
